...
const SuperadminTenants: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f0f4f8] dark:bg-slate-900 flex">
            <Sidebar />
            <main className="flex-1 ml-0 md:ml-80 mr-0 md:mr-4 md:my-0 md:my-4 p-4 md:p-8 pt-8 md:pt-12 rounded-none md:rounded-3xl bg-white dark:bg-slate-900 md:bg-white/50 md:dark:bg-slate-800/50 md:backdrop-blur-sm shadow-soft overflow-y-auto scroll-smooth h-screen md:h-[calc(100vh-2rem)]">
