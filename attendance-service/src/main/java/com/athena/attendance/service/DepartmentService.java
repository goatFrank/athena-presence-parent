...
public interface DepartmentService {
    ...
    DepartmentDTO createDepartment(String name, Long locationId, String locationName, String locationAddress, java.util.UUID adminUserId);
    DepartmentDTO updateDepartment(Long departmentId, String name, Long locationId, String locationName, String locationAddress, java.util.UUID adminUserId);
