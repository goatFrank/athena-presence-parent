        ...
        <>
            ...
            `}>
                ...
                <div className="p-8 pb-4 flex items-center justify-between">
                    <Link to="/dashboard" className="flex items-center gap-3 group cursor-pointer hover:opacity-80 transition-all active:scale-95">
                ...
                <nav ref={navRef} className="flex-1 px-6 space-y-2 mt-2 lg:mt-6 overflow-y-auto scroll-smooth pb-10 lg:pb-0">
                    ...
                    <Link to="/install-app" onClick={closeMobileMenu} className={`flex items-center gap-4 px-5 py-3.5 rounded-2xl font-semibold transition-all ${location.pathname === '/install-app' ? 'bg-blue-50/80 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 shadow-sm ring-1 ring-blue-100 dark:ring-blue-800' : 'text-slate-500 dark:text-slate-400 hover:bg-white dark:hover:bg-slate-800 hover:text-blue-500 group hover:shadow-soft'}`}>
                        <span className={`material-icons text-[22px] transition-colors ${location.pathname === '/install-app' ? 'text-blue-600 dark:text-blue-400' : 'group-hover:text-blue-500'}`}>install_mobile</span>
                        {t('install_app_nav', 'App Mobile')}
                    </Link>
                </nav>
